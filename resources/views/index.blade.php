...
<body style="background:#e2e8f0">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <h4><i class="fa fa-book"></i> BERITA TERBARU</h4>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 shadow-sm border-0 rounded-lg">
                            ...
                            <div class="card-body">
                                <a href="http://" class="text-dark text-decoration-none">
                                    <h6>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Expedita, in.</h6>
                                </a>
                            </div>
                            <div class="card-footer bg-white">
                                <i class="fa fa-calendar" aria- hidden="true"></i> 09 Juli 2020
            ...
            <div class="col-md-4">
                ...
                <div class="card mb-3 shadow-sm border-0">
                    <div class="card-body">
                        <h6>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quos, esse.</h6>
                        <hr>
                        <div>
                            <i class="fa fa-map-marker" aria-hidden="true"></i> Aula Sekolah
                        </div>
                        <div class="mt-2">
                            <i class="fa fa-calendar" aria-hidden="true"></i> 22 Juli 2020
                        </div>
                    </div>
                </div>
                <div class="card mb-3 shadow-sm border-0">
    ...
    <footer>
        ...
        <div class="container-fluid" style="background: #43658b">
            <div class="row p-3">
                <div class="text-center text-white font-weight-bold">
                    Copyright © 2020 PeTIK. All rights reserved.
                </div>
            </div>
        </div>
    </footer>
